...
class GroupInvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_invite" do
    assert_difference('GroupInvite.count') do
      post group_invites_url, params: { group_invite: { accecpted: @group_invite.accecpted, group_id: @group_invite.group_id, receiver_id: @group_invite.receiver_id, sender_id: @group_invite.sender_id } }
    end
  ...
  test "should update group_invite" do
    patch group_invite_url(@group_invite), params: { group_invite: { accecpted: @group_invite.accecpted, group_id: @group_invite.group_id, receiver_id: @group_invite.receiver_id, sender_id: @group_invite.sender_id } }
